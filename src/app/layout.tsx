...
export const viewport:Viewport={themeColor:"#08111d"};
...
export default function RootLayout({children}:{children:ReactNode}){return <html lang="pt-BR" className={`${inter.variable} ${display.variable} ${mono.variable}`}><body>{children}<PwaClient/></body></html>}
