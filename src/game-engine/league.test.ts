...
describe("Brasileirão 2026",()=>{
 it("gera os 20 participantes com o snapshot atual do Transfermarkt",()=>{const league=createLeague("brasil-2026");expect(league.clubs).toHaveLength(20);expect(league.clubs.flatMap(c=>c.players)).toHaveLength(664)});
