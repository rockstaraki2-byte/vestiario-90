...
describe("Brasileirão / SoccerWiki",()=>{
 ...
 it("usa Palmeiras e identidades do catálogo SoccerWiki",()=>{const league=createLeague("catalogo");expect(league.clubs[0].name).toBe("Palmeiras");expect(league.clubs[0].sourceId).toBe(300);expect(league.clubs[0].players[0].sourceId).toBeTruthy()});
