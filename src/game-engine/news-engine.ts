...
export function buildNewsEngineV2(season:SeasonState):GeneratedSportsNews[]{
 ...
 // Cobertura editorial garantida: todo clube ativo aparece com seu resultado mais recente.
