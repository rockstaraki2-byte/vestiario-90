...
export type DatabaseStatusCategory="Liga profissional"|"Base"|"Internacional"|"Estadual"|"Staff";
...
for(const comp of INTERNATIONAL_2026_PARTICIPANTS)rows.push({id:comp.id,name:comp.name,country:intlCountry(comp.id),category:"Internacional",status:comp.clubIds.length?"updated":"pending",clubs:comp.clubIds.length,players:0,photoCoverage:0,crestCoverage:0,snapshot:"2026-09-09",note:"Participantes reais sincronizados; elencos são herdados da entidade de clube das ligas"});
