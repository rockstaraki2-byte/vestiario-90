...
export type BrazilCompetitionDefinition={
 ...
 startDate:string;roundCadenceDays:number;clubs:CompetitionClubRoster[];
};
...
export const BRAZIL_2026_COMPETITIONS:BrazilCompetitionDefinition[]=[
 {id:"BRA1",name:"Campeonato Brasileiro Série A",shortName:"Série A",kind:"professional",season:2026,selectableAsCareer:true,startDate:"2026-01-28",roundCadenceDays:7,clubs:serieA},
 {id:"BRA2",name:"Campeonato Brasileiro Série B",shortName:"Série B",kind:"professional",season:2026,selectableAsCareer:true,startDate:"2026-03-21",roundCadenceDays:7,clubs:get("BRA2")},
 {id:"BRA3",name:"Campeonato Brasileiro Série C",shortName:"Série C",kind:"professional",season:2026,selectableAsCareer:true,startDate:"2026-04-04",roundCadenceDays:7,clubs:get("BRA3")},
 {id:"CB20",name:"Campeonato Brasileiro Sub-20",shortName:"Brasileiro Sub-20",kind:"youth",season:2026,selectableAsCareer:false,startDate:"2026-03-01",roundCadenceDays:7,clubs:get("CB20")},
 {id:"SPjr",name:"Copa São Paulo de Futebol Júnior",shortName:"Copinha",kind:"youth",season:2026,selectableAsCareer:false,startDate:"2026-01-02",roundCadenceDays:3,clubs:get("SPjr")},
];
